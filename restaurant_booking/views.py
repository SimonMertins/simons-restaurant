...
def view_home(request):
    ...
    return render(request, 'restaurant_booking/home.html')  # Replace with your actual template
...
def make_reservation(request):
    ...
    if request.method == 'POST':
        ...
        reservation_datetime = datetime.combine(datetime.today(), datetime.strptime(selected_time, '%H:%M').time())
...
def manage_bookings(request):
    ...
    user_bookings = Booking.objects.filter(user=request.user)  # Assuming the user is authenticated
